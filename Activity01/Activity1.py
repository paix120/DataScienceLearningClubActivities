...
# try again...
# calculate the total of these birds counted and display
#print('\n Count of birds sighted by common name using pivot table:')
...
#print('\n Count of birds sighted by common name using groupby:')
